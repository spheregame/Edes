...
(function(){
    ...
    var parameters = PluginManager.parameters('CommandWindow');
    var cmdnm = parameters['CommandName'];
    var cmdtxt = parameters['CommandHelpText'];
    var CommandName = cmdnm.split(',');
    var CommandHelpText = cmdtxt.split(',');
...
// ウィンドウを定義 
    ...
    Window_CmdInfo.prototype.initialize = function() { 
        Window_Base.prototype.initialize.call(this, -35,-430,820,90);
        this.opacity = 0 
    };
    ...
    Window_ActorCommand.prototype.setConnandName = function() {
        ...
        this.CmdInfo = new Window_CmdInfo();
    ...
    var _Window_ActorCommand_prototype_update = Window_ActorCommand.prototype.update;
        ...
        switch(cmdname) {
            ...
            this.CmdInfo.changeTextColor(this.textColor(16));
